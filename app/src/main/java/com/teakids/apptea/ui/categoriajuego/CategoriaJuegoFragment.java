...
import com.teakids.apptea.ui.DetalleCategoriaJuego.DetalleJuegoPaciente;
import com.teakids.apptea.ui.DetalleCategoriaJuego.Detalle_Juego;
                ...
                if (bandera) {
                    ...
                    if (administarSesion.obtenerIDSesion() > 0) {
                        ...
                        if(administarSesion.getIdioma()==1){
                            ...
                            detalleSesion.setNombre_opcion(getResources().getString(R.string.categoriaJuego)+" " + categoriaJuego.getCategoryNameGame());}
